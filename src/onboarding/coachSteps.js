...
export const COACH_STEPS = [
  ...
  },
  {
    ...
    how: 'Select the cube and press R (Scale). Make the LENGTH and WIDTH bigger than 4, and the THICKNESS (height) thin — about 0.5 (under 1). Easiest way: open Properties → Dimensions and type W, D above 4 and H around 0.5.',
    shortcut: 'R',
    cta: 'Length & width > 4, thickness ~0.5 (a thin flat plate).',
  ...
  {
    id: 'add-wheels', selector: 'shape-cylinder', icon: '⭕', exitTools: true,
    title: 'Step 5 — Add two wheels',
    why: 'You need one wheel per motor to roll the robot.',
    how: 'Open the Library section and click the highlighted Cylinder button TWICE for two wheels. Then Scale each one UP (bigger diameter) so it looks like a real wheel, and move it next to a motor.',
    cta: 'Add TWO Cylinders and size them up into wheels.',
  ...
  },
  {
    ...
    how: 'Select a wheel: click ◎ Pick Attachment Point then click the spot that meets the motor — OR if a "✓ Attach" prompt appears (wheel near a motor), just click it. Do BOTH wheels.',
    cta: 'Attach BOTH wheels to the motors (Pick Attachment Point or ✓ Attach).',
