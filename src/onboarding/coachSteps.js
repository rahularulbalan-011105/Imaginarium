...
export const COACH_STEPS = [
  ...
  },
  {
    ...
    title: 'Step 5 — Add wheels',
    why: 'Wheels are what the motors spin to roll the robot.',
    how: 'In the Library section, scroll to MODELS and click Wheels — a ready-made wheel model.',
    cta: 'Add the Wheels model from the Library.',
    success: 'Nice wheels! 🛞',
    detect: { type: 'objectType', any: ['model', 'cylinder'] },
  },
  {
    id: 'attach-wheel', selector: 'panel', icon: '◎',
    title: 'Step 6 — Attach the wheels to a motor',
    why: 'A wheel only rolls the robot once it is mounted on a motor’s spinning shaft.',
    how: 'Select the wheels, then in Properties click ◎ Pick Attachment Point and click the spot on the wheels that touches the motor’s shaft. They snap on and spin with the motor.',
    cta: 'Use ◎ Pick Attachment Point to mount the wheels on a motor.',
    success: 'Wheels mounted on the motor — they’ll spin! 🛞',
    detect: { type: 'attach' },
  },
  {
