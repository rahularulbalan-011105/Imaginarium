...
export const COACH_STEPS = [
  ...
  // ── Move: activate, then use ────────────────────────────────────────────────
  {
    ...
    how: 'Click the Move tool in the toolbox, or press W. (Move is the default, so it may already be active.)',
    shortcut: 'W',
  ...
  // ── Rotate: activate, then use ──────────────────────────────────────────────
  {
    ...
    how: 'Click the Rotate tool in the toolbox, or press E.',
    shortcut: 'E',
  ...
  // ── Scale: activate, then use ───────────────────────────────────────────────
  {
    ...
    how: 'Click the Scale tool in the toolbox, or press R.',
    shortcut: 'R',
  ...
  // ── Simulation: physics + environment (distinct from code execution) ───────
  {
    ...
    how: 'Open the Sim section in the right panel, then click Start Simulation (▶).',
    cta: 'Start Simulation (▶) to enter simulation mode.',
  ...
  },
  {
    ...
    how: 'In the Sim section, click the button again (it now shows ⏹ Stop Simulation) to exit.',
