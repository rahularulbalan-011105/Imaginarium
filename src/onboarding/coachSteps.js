...
export const COACH_STEPS = [
  ...
  },
  {
    ...
    how: 'Open the Library section, then click the highlighted Cylinder button TWICE to add two wheels. Move each next to a motor.',
    cta: 'Click Cylinder twice — add TWO wheels.',
