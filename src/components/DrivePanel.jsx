        ...
        <div className="flex items-center gap-5 px-4 py-2.5">
          ...
          <div className="shrink-0 grid grid-cols-3 grid-rows-3 gap-1 w-[88px] h-[88px]">
            ...
            <button
              ...
              className="flex items-center justify-center bg-gray-700 hover:bg-green-700 active:bg-green-600 rounded text-slate-800 text-[14px] select-none cursor-pointer transition-colors"
            >▲</button>
            <div />
            <button
